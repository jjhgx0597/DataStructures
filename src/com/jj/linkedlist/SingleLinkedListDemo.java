...
public class SingleLinkedListDemo {
	...
	public static void main(String[] args) {
		...
		HeroNode hero8 = new HeroNode(7, "林冲", "豹子头");
...
//		HeroNode heroNode = mergeTwoList(singleLinkedList.getHead(), singleLinkedList2.getHead());
		HeroNode heroNode = mergeByOrder(singleLinkedList.getHead(), singleLinkedList2.getHead());
		SingleLinkedList list = new SingleLinkedList();
		list.setHead(heroNode);
		System.out.println("合并后链表的情况~~");
		list.list();
...
*/
	...
	//合并2个有序的单向链表，合并之后的链表任然有序【课后练习】
	//方法1：迭代
	public static HeroNode mergeByOrder(HeroNode head1,HeroNode head2){
	...
	public static HeroNode mergeTwoList(HeroNode head1,HeroNode head2){
		 if (head1.next==null){
			 ...
			 head2.next=mergeTwoList(head2.next,head1);
			 return head2;
		 }
